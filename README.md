...
## 🛠️ Tech Stack
- **HTML5**: Semantic document structure, data tables, forms, audio/video players.
- **CSS3**: Flexbox layouts, keyframe animations (`@keyframes`), hover transitions, responsive design.
